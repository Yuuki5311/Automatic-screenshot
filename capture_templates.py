...
TEMPLATES = [
    ...
    # ======== 游戏登录界面 ========
    ("game_logout_btn.png",      "退出登录按钮",                 "游戏画面右上角"),
    ("game_logout_confirm.png",  "退出确认弹窗中的「确定」按钮",   "退出确认弹窗中央"),
    ("game_wx_ios.png",          "「与微信iOS好友玩」绿色按钮",   "游戏登录界面 — 绿色背景"),
    ("game_wx_android.png",      "「与微信安卓好友玩」绿色按钮",  "游戏登录界面 — 绿色背景"),
    ("game_qq_ios.png",          "「与QQ iOS好友玩」蓝色按钮",    "游戏登录界面 — 蓝色背景"),
    ("game_qq_android.png",      "「与QQ安卓好友玩」蓝色按钮",    "游戏登录界面 — 蓝色背景"),
